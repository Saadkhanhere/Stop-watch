...
function startPause(){
	if(running == 0){
		running = 1;
		increment();
		document.getElementById("startPause").style.backgroundColor = "#c9302c";
		document.getElementById("startPause").style.color = "#fff";
...
function reset(){
	running = 0;
	time = 0;
	document.getElementById("startPause").style.backgroundColor = "#286090";
	document.getElementById("startPause").style.color = "#fff";
	document.getElementById("startPause").innerHTML = "<i class='glyphicon glyphicon-play'></i> Start";
